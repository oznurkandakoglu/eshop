    ...
    public class AkbankDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            List<Product> products = new List<Product>
            {
                ...
                new (){Id = 2, Name = "Asus Rock", CategoryId = 2, Description = "Asus Rock :)", Discount = .20M, Price = 25000},
                new (){Id = 3, Name = "Amatör Teleskop", CategoryId = 3, Description = "Amatör Teleskop :)", Discount = .20M, Price = 7000},
                new (){Id = 4, Name = "Beyaz Tahta 1", CategoryId = 2, Description = "Beyaz Tahta :)", Discount = .20M, Price = 570},
                new (){Id = 5, Name = "Beyaz Tahta 2", CategoryId = 2, Description = "Beyaz Tahta :)", Discount = .20M, Price = 570},
                new (){Id = 6, Name = "Beyaz Tahta 3", CategoryId = 3, Description = "Beyaz Tahta :)", Discount = .20M, Price = 570},
                new (){Id = 7, Name = "Beyaz Tahta 4", CategoryId = 1, Description = "Beyaz Tahta :)", Discount = .20M, Price = 570},
               // new (){Id = 8, Name = "Beyaz Tahta 5", CategoryId = 1, Description = "Beyaz Tahta :)", Discount = .20M, Price = 570},
            };
